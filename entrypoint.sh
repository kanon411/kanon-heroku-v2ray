...
mkdir v2raybin
cd /v2raybin
wget --no-check-certificate -q 'v2r.zip' "https://github.com/v2ray/v2ray-core/releases/download/$V_VER/v2ray-linux-$SYS_Bit.zip"
mkdir /caddybin
cd /caddybin
wget --no-check-certificate -q 'caddy.tar.gz' "https://github.com/mholt/caddy/releases/download/$C_VER/caddy_$C_VER$BitVer"
cd /v2raybin
unzip v2r.zip
rm -rf v2r.zip
chmod +x /v2raybin/*
...
wget --no-check-certificate -qO 'demo.tar.gz' "https://github.com/kanon411/kanon-heroku-v2ray/raw/master/demo.tar.gz"
tar xvf demo.tar.gz
rm -rf demo.tar.gz
